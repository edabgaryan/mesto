...
const buttonClosePopupFormProfile = popupFormProfile.querySelector(
...
const placeSourceFormPopup = document.querySelector(
  selectors.placeSourceFormPopup
);
// Profile
...
const popupFull = [popupFormProfile, popupFormAdd, popupOpenPicture];
...
function submitFormPlace() {
  renderCard({
    name: namePlaceFormPopup.value,
    link: placeSourceFormPopup.value,
  });
  closePopup(popupFormAdd);
  popupFormPlace.reset();
}

popupFull.forEach((popup) => {
...
function createCard({ name, link }) {
  ...
  //Кнопка "trash
  elementCopy
    .querySelector(selectors.trashButton)
